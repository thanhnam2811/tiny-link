		...
		<main className="flex min-h-screen flex-col items-center justify-center px-4 bg-background">
			...
			>
				...
				<motion.div
					...
					className="mx-auto w-20 h-20 rounded-xl bg-muted flex items-center justify-center mb-8"
				>
				...
				<Link
					href="/"
					className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-md font-heading font-semibold text-sm hover:bg-primary/90 transition-colors shadow-sm"
				>
