...
```ts
const clientBaseUrl = process.env.NEXT_PUBLIC_CLIENT_URL || (typeof window !== 'undefined' ? window.location.origin : '');
// Copy:
...
- [ ] Copied link string matches configured public client URL.
