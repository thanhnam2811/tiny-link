...
- [ ] Mobile viewports display Topbar + Hamburger menu allowing seamless tab navigation and logout.

#### 6. ✅ Definition of Done (DoD) & Verification Plan
- [ ] Verify responsive layout across 375px, 768px, and 1280px viewports.
